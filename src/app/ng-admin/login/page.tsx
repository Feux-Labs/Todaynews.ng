  ...
  return (
    <div className="min-h-screen bg-[#060b18] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Suspense fallback={
          <div className="bg-[#0f1729]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-8 text-center text-slate-400">
            <Loader2 className="w-6 h-6 animate-spin mx-auto text-[#00e676]" />
