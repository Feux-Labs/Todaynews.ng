...
export default function AgentPanel() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {resultMessage && (
        <div
          className={`mb-3 max-w-sm rounded-xl p-3.5 shadow-2xl border text-xs leading-relaxed flex items-start gap-2.5 animate-in fade-in slide-in-from-bottom-3 duration-300 ${
            isSuccess
              ? "bg-[#eff6ff] dark:bg-blue-950 border-[#2563eb]/40 text-blue-900 dark:text-blue-200 shadow-[#2563eb]/10"
              : "bg-[#fef2f2] dark:bg-red-950 border-red-500/40 text-red-800 dark:text-red-300 shadow-red-500/10"
          }`}
        >
          {isSuccess ? (
      ...
      {isOpen && (
        <div className="mb-3 w-[360px] sm:w-[400px] bg-slate-50/95 dark:bg-slate-800/95 backdrop-blur-xl border border-[#2563eb]/30 rounded-2xl shadow-2xl shadow-black/80 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          {/* Header */}
          <div className="p-3.5 bg-gradient-to-r from-[#2563eb]/10 to-transparent border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          ...
          <div className="p-3.5 space-y-3 max-h-[380px] overflow-y-auto custom-scrollbar">
            <div className="text-[11px] uppercase tracking-wider font-semibold text-slate-400 dark:text-slate-500 flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-[#2563eb]/10 border border-slate-200 dark:border-slate-700 hover:border-[#2563eb]/40 text-left transition group disabled:opacity-50"
              >
                <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-blue-500/10 border border-slate-200 dark:border-slate-700 hover:border-blue-500/40 text-left transition group disabled:opacity-50"
              >
                <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-500 text-left transition group disabled:opacity-50"
              >
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 flex items-center justify-center group-hover:scale-110 transition">
                ...
                <span className="text-[10px] font-mono text-slate-600 dark:text-slate-400 px-1.5 py-0.5 rounded bg-slate-200 dark:bg-slate-700">
                  Run
                </span>
              </button>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 hover:border-slate-500 text-left transition group disabled:opacity-50"
              >
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-slate-300 dark:bg-slate-600 text-slate-800 dark:text-slate-200 flex items-center justify-center group-hover:scale-110 transition">
                ...
                <span className="text-[10px] font-mono text-slate-700 dark:text-slate-300 px-1.5 py-0.5 rounded bg-slate-300 dark:bg-slate-600">
                  Publish
                </span>
              </button>
            </div>
          ...
          <form
            ...
            className="p-3 bg-slate-50 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 flex items-center gap-2"
          >
            <input
              type="text"
              value={customPrompt}
              ...
              className="flex-1 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:border-[#2563eb]/50"
            />
            <button
              type="submit"
      ...
      <button
        ...
        className="relative group flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-[#eff6ff] hover:bg-[#dbeafe] dark:bg-blue-950 dark:hover:bg-blue-900 border border-[#2563eb]/40 hover:border-[#2563eb] shadow-xl shadow-black/80 hover:shadow-[#2563eb]/20 transition-all duration-300 transform hover:-translate-y-0.5"
      >
